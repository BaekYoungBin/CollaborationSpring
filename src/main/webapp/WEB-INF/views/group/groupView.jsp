...
/* function loadcreateGroupModal() {
	...
	$('#reg_grp').on('hidden.bs.modal', function(e) {
		loadGroup();
	});
	function joinGroupMain(seq_grp_number) {
		location.href = "/grouping/group/joinGroupMain.do?seq_grp_number="
				+ seq_grp_number;
													...
													<tr>
														...
														<td>
															<button id="${grp.seq_grp_number}"
																onclick="joinGroupMain(this.id);">그룹 입장</button>
														</td>
													</tr>
												</c:forEach>
											</tbody>
							...
							<div class="modal-dialog">
								...
								<div class="modal-content">
									...
									<form id="createGroup">
										<div class="modal-body">
											<div class="form-group">
												그룹 이름: <input type="text" class="form-control"
													id="grp_title" name="grp_title">
											</div>
											<div class="form-group">
												그룹 정보:
									...
									<div class="modal-footer">
										<Button type="button" class="btn" id="creBtn"
											onclick="createGroup();">그룹 생성</Button>
									</div>
						...
						<div class="panel panel-default panel-table prj"
							...
							<div class="group-header">
								...
								<a href="javascript:void(0);" name="${grp.seq_grp_number }"
									onclick="removeNewestGroup(this.name);"><span
							...
							<div class="group_footer">
								<button class="btn btn-sm btn-primary btn-create group_sel_btn "
									id="${grp.seq_grp_number}" onclick="joinGroupMain(this.id);">그룹
									입장</button>
							</div>
						</div>
					</c:forEach>
